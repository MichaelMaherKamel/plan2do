...
export default function HeroSection() {
  return (
    <section className='w-full py-20 md:min-h-screen lg:min-h-screen relative overflow-hidden flex items-center'>
        ...
        <div className='grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]'>
          <div className='flex flex-col justify-center space-y-4'>
            <div className='space-y-2'>
              {/* Centered on small and medium screens, left-aligned on lg screens */}
              ...
              <h1 className='text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-primary/90 text-center lg:text-left'>
            ...
            {/* Social proof badges - centered on small and medium screens, left-aligned on lg screens */}
